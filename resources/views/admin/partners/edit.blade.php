    ...
    <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <label class="block">
            ...
            @if($partner->logo_path)
                <div class="mb-3">
                    <img src="{{ asset('storage/'.$partner->logo_path) }}" class="w-32 h-16 object-contain">
                </div>
            @endif
