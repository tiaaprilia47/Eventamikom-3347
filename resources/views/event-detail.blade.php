        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-wrap gap-6 text-slate-500 font-medium">
                <div class="flex items-center gap-2">
                    ...
                    <span>{{ $event->date ? $event->date->format('l, d M Y') : 'Segera' }}</span>
                </div>
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-indigo-600 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl shadow-indigo-200 relative overflow-hidden">
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div>
                    ...
                    @else
                        <button disabled class="inline-block px-10 py-5 bg-slate-400 text-white rounded-2xl font-black text-xl cursor-not-allowed shadow-xl">
                            Habis
                        </button>
                    @endif
                </div>
